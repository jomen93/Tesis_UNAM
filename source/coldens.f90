...
program coldens
  ...
  ! Run Parameters
  integer, parameter :: outmin = 219
  integer, parameter :: outmax = 219
  ...
  integer, parameter :: int_type = INT_COLDENS
 ...
 ! variable definitions to performance the rotations 
  ...
  logical, parameter :: output_rg = .false.     ! Direct binary output
  
  ! Filenames
  character(*), parameter :: datadir    = "/storage2/jsmendezh/raytracing/data"         ! Path to data dir
...
!      write(*,'(i0,a)',advance='no') bID, " ... "
      ...
      ! define reference vector for xray integration
        ...
        do j=1,ncells_y
          do k=1,ncells_z
            ...
            ! if (dist1.gt.r1.and.dist2.gt.r2) then            
              ...
              ! write(*,*) "Coordenadas de salida", i, j, k
              call absCoords (bID,i,j,k,mesh,i1,j1,k1)
              ! write(*,*) "Posicion de llegada del rayo ", i1, j1, k2
              ...
              ! write(*, *) "Posicion de llegada del rayo 2", i2, j2, k2
            ! end if
          end do
        end do
      end do
