...
program extract
  ...
  real, parameter :: cut_location = 30 * AU

  logical, parameter :: cut_output_bin = .true.
  logical, parameter :: cut_output_vtk = .false.
...
subroutine write2Dbin (outmap, nx, ny, outfname)
  ...
  write(*,'(1x,a,1x,i0,1x,i0,1x,i0)') "Dimensions", nx, ny, neqtot 
